                ...
                Container(
                  decoration: const BoxDecoration(
                    ...
                    image: DecorationImage(
                        image: AssetImage("assets/logindemo/background.png"),
                        fit: BoxFit.cover),
                  ),
                    ...
                    children: <Widget>[
                      Positioned(
                        ...
                        child: FadeInUp(duration: Duration(seconds: 1), child: Container(
                          decoration: BoxDecoration(
                              image: DecorationImage(
                                  image: AssetImage('assets/logindemo/light-1.png')
                              )
                          ),
                        )),
                      ),
                      Positioned(
                        ...
                        child: FadeInUp(duration: Duration(milliseconds: 1200), child: Container(
                          decoration: BoxDecoration(
                              image: DecorationImage(
                                  image: AssetImage('assets/logindemo/light-2.png')
                              )
                          ),
                        )),
                      ),
                      Positioned(
                        ...
                        child: FadeInUp(duration: Duration(milliseconds: 1300), child: Container(
                          decoration: BoxDecoration(
                              image: DecorationImage(
                                  image: AssetImage('assets/logindemo/clock.png')
                              )
                          ),
                        )),
                      ),
