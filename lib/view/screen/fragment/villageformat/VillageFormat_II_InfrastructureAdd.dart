...
// This widget is the root of your application.
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const VillageFormat_II_InfrastructureAdd(),
    );
  }
}

class VillageFormat_II_InfrastructureAdd extends StatefulWidget {
  const VillageFormat_II_InfrastructureAdd({super.key});

  @override
  State<VillageFormat_II_InfrastructureAdd> createState() =>
      _village_format_i_addState();
}

class _village_format_i_addState
    extends State<VillageFormat_II_InfrastructureAdd> {
      ...
      home: Scaffold(
          appBar: AppBar(
            ...
            title: Align(
                ...
                child: ToolbarTextView(AppString.title_assessment_format_II,FontSize.sp_18,CustomColor.white,FontWeight.bold)),
                              ...
                              children: [
                                Container(
                                  ...
                                  child: ExpandableTextWidget(
                                    text: 'Format – II: Village level Data for Infrastructure Development and Action Plan for fulfilling the needs identified',
                                    textStyle: TextStyle(
                                        fontSize: 18.00,
                                    ...
                                    child: Column(
                                      children: [
                                        ExpandableTextWidget(
                                          text: 'Status of filling up of Monitorable Indicator of the village.',
                                          textStyle: TextStyle(
                                              fontSize: 18.0,
                                              color: CustomColor.white),
                                          maxLines: 4,
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        child: GestureDetector(
                                          ...
                                          child: DropDownFormField(
                                            titleText: 'Monitorable Indicator',
                                            hintText: ' --Select---',
                                            value: _myActivity,
                                            onSaved: (value) {
                                              setState(() {
                                            ...
                                            dataSource: [
                                              ...
                                              {
                                                "display":
                                                    "1.4 - Have toilets been provided in all Schools & Anganwadis in the village?",
                                                "value":
                                                    "1.4 - Have toilets been provided in all Schools & Anganwadis in the village?",
                                              },
                                              {
                                              ...
                                              {
                                                "display":
                                                    "1.8 - % of solid and liquid waste being disposed effectively",
                                                "value":
                                                    "1.8 - % of solid and liquid waste being disposed effectively",
                                              },
                                            ],
